...
const navigationCategories: NavigationCategory[] = [
  {
    ...
    items: [
      ...
      {
        name: "2257 Verification Dashboard",
        href: "/verification-dashboard",
        icon: Shield,
        description: "Unified dashboard for all creator & co-star verifications",
        requiresCompliance: true,
        complianceLevel: "2257_OFFICER",
        requiresSuperAdmin: true,
      },
      {
        name: "Co-Star Verification Management",
        href: "/verification-management",
        icon: UserCheck,
        description: "Review and approve 2257 co-star verification submissions",
        requiresCompliance: true,
        complianceLevel: "2257_OFFICER",
        requiresSuperAdmin: true,
      },
      {
        name: "Submit Co-Star Verification",
        href: "/costar-verification",
        icon: FileText,
        description: "Adult Co-Star Model Release + 2257 Compliance Form",
        requiresCompliance: true,
        complianceLevel: "MODERATOR",
      },
      {
        ...
        icon: Shield,
        description: "Primary Creator Identity Verification + 2257 + Platform Agreement",
        requiresCompliance: true,
        complianceLevel: "CREATOR",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    icon: Library,
    description: "Knowledge base, policies & guides",
    items: [
      {
        name: "Knowledge Base",
        href: "https://kb.fanz.website",
        icon: Library,
        description: "Comprehensive wiki, policies & documentation",
        isExternal: true,
      },
      {
        name: "Content Rules",
        href: "https://kb.fanz.website/#content-rules",
        icon: Scale,
        description: "Platform content standards & guidelines",
        isExternal: true,
        requiresCompliance: true,
        complianceLevel: "MODERATOR",
      },
      {
        name: "Moderator Guides",
        href: "https://kb.fanz.website/#mod-guides",
        icon: Gavel,
        description: "Moderation procedures & escalation protocols",
        isExternal: true,
        requiresCompliance: true,
        complianceLevel: "MODERATOR",
      },
      {
        name: "Legal Policies",
        href: "https://kb.fanz.website/#policies",
        icon: ScrollText,
        description: "Terms, privacy, DMCA, 2257 & compliance policies",
        isExternal: true,
        requiresCompliance: true,
        complianceLevel: "COMPLIANCE_OFFICER",
      },
      {
        ...
        href: "https://payconfig.fanz.website",
        icon: Wallet,
        description: "Payment processor settings & payout management",
        isExternal: true,
        requiresSuperAdmin: true,
      },
    ],
  ...
  },
  {
    ...
    name: "ENTERPRISE OPS",
    icon: Briefcase,
    description: "Business operations & enterprise management",
    items: [
      {
        name: "CRM System",
        href: "/crm-system",
        icon: Building2,
        description: "Customer relationship management - leads, clients, deals & proposals",
      },
      {
        name: "ERP System",
        href: "/erp-system",
        icon: Cpu,
        description: "Enterprise resource planning - inventory, projects, resources & financials",
      },
      {
        name: "HR Management",
        href: "/hr-management",
        icon: UserCog,
        description: "Human resources - employees, payroll, performance & benefits",
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        name: "Advanced Analytics (GA4/GTM)",
        href: "/analytics-dashboard",
        icon: TrendingUp,
        description: "GA4, GTM, and social pixel tracking configuration",
        requiresSuperAdmin: true,
      },
      {
        ...
        href: "/admin-config",
        icon: Workflow,
        description: "OAuth, workflows, permissions & scheduling management",
        requiresSuperAdmin: true,
      },
      {
                        ...
                        >
                          <div className="flex items-center space-x-3 flex-1">
                            ...
                            <div className="flex-1 min-w-0">
                              <div
                                className={cn(
                                  "text-sm font-medium truncate transition-colors duration-200 flex items-center gap-1",
                                  isActive
                              ...
                              {(item.requiresCompliance ||
                                ...
                                <div className="flex gap-1 mt-1 flex-wrap">
                                  {item.isExternal && (
                                    <Badge
                                      variant="outline"
                                      className="text-xs py-0 px-1 text-cyan-400 border-cyan-400"
                                    >
                                      EXTERNAL
                                    </Badge>
                                  )}
